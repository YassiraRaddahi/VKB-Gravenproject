                                        ...
                                        <template v-if="editMode">
                                            ...
                                            <v-row>
                                                ...
                                                <v-col cols="12" md="4">
                                                    ...
                                                    <v-text-field v-model="newManager.first_name" label="Voornaam"
...
const managerFullName = (manager) =>
    `${manager.first_name} ${manager.infix || ''} ${manager.last_name}`.trim()
...
async function createManager() {
    ...
    try {
        ...
        const payload = {
            first_name: newManager.value.first_name.trim(),
