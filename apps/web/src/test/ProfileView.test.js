...
// describe('Cemetery Manager', () => {

//     it('sees correct fields', () => {
//         const admin = setupRole('cemetery manager')
...
//                 && admin.permissions.includes(permission.replace('edit', 'view'))
//             ) {
//                 expectFieldsReadonly(wrapper, fields)
//             }
//         })
...
// describe('Grave Owner', () => {

//     it('sees correct fields', () => {
//         const admin = setupRole('grave owner')
...
// describe('Grave Caretaker', () => {

//     it('sees correct fields', () => {
//         const admin = setupRole('grave caretaker')
